 ...
 */
public class Tip {
    private static final String[] SATISFACTION = { "Totally satisfied", "Satisfied", "Dissatisfied" };
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.printf("%s%nTip: $%.2f (%.0f%%)%n", SATISFACTION[satisfaction - 1], tipRate * amount, tipRate * 100);
    }
}
